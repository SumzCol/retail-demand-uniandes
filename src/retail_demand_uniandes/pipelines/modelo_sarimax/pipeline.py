    ...
    return pipeline(
        [
            node(
                ...
                inputs=dict(
                    df_raw="olist_consolidated_dataset", params="params:modelo_sarimax"
                ),
            ...
            node(
                ...
                inputs=dict(
                    agg="resultadofinal",
                    non_stationary="productos_no_estacionarios",
                    params="params:modelo_sarimax",
                ),
            ...
            node(
                func=prepare_exog,
                inputs=dict(
                    agg_diff="series_diferenciadas", params="params:modelo_sarimax"
                ),
                outputs="exog_dict",
                name="prepare_exog",
            ),
            ...
            node(
                ...
                inputs=dict(
                    results="resultados_modelos_sarimax", params="params:modelo_sarimax"
                ),
